...
import com.farydrop.photoeditor.tools.EditingToolsAdapter.OnItemSelected
import com.farydrop.photoeditor.filters.FilterListener
import com.farydrop.photoeditor.filters.FilterViewAdapter
import com.farydrop.photoeditor.tools.EditingToolsAdapter
import com.farydrop.photoeditor.tools.ToolType
...
class EditImageActivity : BaseActivity(), OnPhotoEditorListener, View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mPhotoEditorView.source.setImageResource(R.drawable.photobc)
    ...
    private fun initViews() {
        ...
        mTxtCurrentTool = findViewById(R.id.tvCurrentTool)
        mRvTools = findViewById(R.id.rvConstraintTools)
        mRvFilters = findViewById(R.id.rvFilterView)
        mRootView = findViewById(R.id.rootView)

        val imgUndo: ImageView = findViewById(R.id.ivUndo)
        imgUndo.setOnClickListener(this)

        val imgRedo: ImageView = findViewById(R.id.ivRedo)
        imgRedo.setOnClickListener(this)

        val imgCamera: ImageView = findViewById(R.id.ivCamera)
        imgCamera.setOnClickListener(this)

        val imgGallery: ImageView = findViewById(R.id.ivGallery)
        imgGallery.setOnClickListener(this)

        val imgSave: ImageView = findViewById(R.id.imgSave)
        imgSave.setOnClickListener(this)

        val imgClose: ImageView = findViewById(R.id.ivClose)
    ...
    override fun onClick(view: View) {
        when (view.id) {
            R.id.ivUndo -> mPhotoEditor.undo()
            R.id.ivRedo -> mPhotoEditor.redo()
